...
@Component({
	selector: 'exportsingernlp',
	templateUrl: './exportsingernlp.component.html',
	styleUrls: ['./exportsingernlp.component.css']
})

export class ExportSingerNlpComponent {
displayedColumns = ['checkBox', 'singerName', 'cleanedSingerName'];
